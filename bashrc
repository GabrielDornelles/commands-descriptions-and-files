...
bash_prompt() {
	...
	FONT_COLOR_4=$BLACK; BACKGROUND_4=$YELLOW; TEXTEFFECT_4=$BOLD
	...
	local GIT_BRANCH_TAG=$"$TEXT_FORMAT_4\${GIT_BRANCH}"
	local PROMT_INPUT=$"$PROMT_FORMAT"


	############################################################################
	## SEPARATOR FORMATING                                 WHITE_BOLD                  ##
	...
	*)
	...
	############################################################################
	PS1="$TITLEBAR\n${PROMT_USER}${SEPARATOR_1}${PROMT_HOST}${SEPARATOR_2}${PROMT_PWD}${SEPARATOR_3}${GIT_BRANCH_TAG}${SEPARATOR_3}${PROMT_INPUT}$ "
